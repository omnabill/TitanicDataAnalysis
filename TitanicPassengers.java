 ...
 */
public class TitanicPassengers {
    ...
    public String toString() {
        return "TitanicPassengers{" + "pclass=" + pclass + ", survived=" + survived + ", name=" + name + ", sex=" + sex + ", age=" + age + ", sibsp=" + sibsp + ", parch=" + parch + ", ticket=" + ticket + ", fare=" + fare + ", cabin=" + cabin + ", embarked=" + embarked + ", boat=" + boat + ", body=" + body + ", home_dest=" + home_dest + '}';
    }
